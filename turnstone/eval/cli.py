...
def main() -> None:
    ...
    parser.add_argument(
        "--arms",
        default=None,
        help="--nudges: comma-separated arms overriding each cell's own list",
    )
    parser.add_argument(
        "--body-override",
        default=None,
        help=(
            ...
            "NUDGE_IDLE_TASKS_HEADER for this sweep (tuning A/B only; the "
            "default is always the production body)"
        ),
    )
    parser.add_argument(
        "-v",
